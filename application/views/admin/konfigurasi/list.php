...
?>
   <div class="form-group row">
    ...
    <div class="form-group row">
    <label class="col-md-3 col-form-label">Tagline/Moto</label>
    <div class="col-md-8">
    ...
    <div class="col-md-8">
        <input type="text" name="telepon" class="form-control" placeholder="Telepon/HP" value=
    ...
    <div class="form-group row">
    <label class="col-md-3 col-form-label">Kode Metatext</label>
    <div class="col-md-9">
