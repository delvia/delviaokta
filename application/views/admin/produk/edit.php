...
?>
   <div class="form-group row">
    ...
    <div class="col-md-5">
       <select name="id_kategori" class="form-control">
           <?php foreach($kategori as $kategori) { ?>
            <option value="<?php echo $kategori->id_kategori ?>" <?php if($produk->id_kategori==$kategori->
                id_kategori) { echo "selected";} ?>>
    ...
    <div class="col-md-5">
        <input type="number" name="harga" class="form-control" placeholder="Harga Produk" value=
    ...
    <div class="col-md-5">
        <input type="number" name="stok" class="form-control" placeholder="Stok Produk" value=
    ...
    <div class="col-md-10">
        <textarea name="keterangan"  class="form-control" placeholder="Keterangan Produk" id="editor">
            <?php echo  $produk->keterangan ?> </textarea>
    </div>
    </div>
    ...
    <div class="col-md-10">
        ...
        <?php echo  $produk->keywords ?> </textarea>
    </div>
    </div>
    ...
    <select name="status_produk" class="form-control">
            ...
            <option value="Draf" <?php if($produk->status_produk=="Draf") { echo "selected"; } ?>>Simpan Sebagai Draft</option>
    </select>
    </div>
    </div>
