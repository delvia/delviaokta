<p class="pull-right">
    <div class="btn-group pull-right">
        <a href="<?php echo base_url('admin/transaksi/cetak/'.
        $header_transaksi->kode_transaksi) ?>" target="_blank" title="Cetak" class="btn btn-success btn-sm">
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            <td>Bukti Bayar</td>
            <td><?php if($header_transaksi->bukti_bayar =="") { echo 'Belum ada'; 
                }else{?>
        ...
        <tr>
            ...
            <?php echo $header_transaksi->nomor_rekening?> a.n <?php echo $header_transaksi->nama_pemilik ?>
