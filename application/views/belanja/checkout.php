...
<div class="wrap-table-shopping-cart bgwhite">
    ...
    <table class="table-shopping-cart">
        ...
        <tr class="table-row">
            ...
            <td class="column-3"> Rp. <?php echo number_format($keranjang['price'],
								'0',',','.') ?> </td>
            <td class="column-4">
    ...
    <table class="table">
            <thead>
                <tr>
                    ...
                    <th><input type="text" name="kode_transaksi" class="form-control" value="<?php echo $kode_transaksi ?>"
                     readonly requiered></th>
                </tr>

                <tr>
                    <td>Nama Penerima</td>
                    <td><input type="text" name="nama_pelanggan" class="form-control" placeholder="Nama Pelanggan"
            ...
            <tbody>
                <tr>
                    ...
                    value= "<?php echo $pelanggan->email ?>" requiered></td>
                </tr>   
