...
<div class="wrap-table-shopping-cart bgwhite">
    ...
    <table class="table-shopping-cart">
        ...
        <tr>
         ...
         <br>
    <p class="pull-right">
        <a href="<?php echo base_url('belanja/hapus') ?>" class="btn btn-danger bnt-lg">
                <i class="fa fa-trash"></i> Bersihkan Keranjang Belanja
        </a>

        <a href="<?php echo base_url('belanja/chekout') ?>" class="btn btn-success bnt-lg">
