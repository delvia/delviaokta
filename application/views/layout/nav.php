...
?>
			...
			<div class="header-cart header-dropdown">
				...
				//kalau ada
					...
					foreach($keranjang as $keranjang) {
						...
						//dari sini bisa ambil data gambarnya
					?>
					...
					<li class="header-cart-item">
						...
						<div class="header-cart-item-txt">
							...
							<span class="header-cart-item-info">
								<?php echo $keranjang['qty'] ?> x Rp. <?php echo number_format($keranjang['price'],
								'0',',','.') ?>: Rp. <?php echo number_format($keranjang['subtotal'],
								'0',',','.') ?>
				...
				//kalau ada
					...
					<li class="header-cart-item">
						...
						<div class="header-cart-item-txt">
							...
							<span class="header-cart-item-info">
							<?php echo $keranjang_mobile['qty'] ?> x Rp. <?php echo number_format($keranjang_mobile['price'],
								'0',',','.') ?>
							</span>
						</div>
					</li>
	...
	<ul class="main-menu">
		...
		<!-- MENU MOBILE PRODUK -->
		<li class="item-menu-mobile">
			<a href="<?php echo base_url('produk')?>">Beranda &amp; Belanja</a>
			<ul class="sub-menu">
