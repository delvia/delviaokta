...
<div class="flex-w flex-sb">
            ...
            <div class="slick3">
                ...
                $produk->gambar) ?>">
                    <div class="wrap-pic-w">
                        ...
                        $produk->gambar) ?>" alt="<?php echo $produk->nama_produk ?>">
                    </div>
                </div>
                <?php if($gambar){
                ...
                <div class="item-slick3" data-thumb="<?php echo base_url('assets/upload/image/thumbs/'.
                    ...
                    <div class="wrap-pic-w">
                        <img src="<?php echo base_url('assets/upload/image/'.
                        $gambar->gambar) ?>" alt="<?php echo $gambar->judul_gambar ?>">
                    </div>
                </div>
                <?php
                    }
    ...
    <div class="w-size14 p-t-30 respon5">
        ...
        <?php 
            //form untuk memperoses belanjaan
        ...
        <?php 
            ...
            <div class="block2">
                <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                    <img src="<?php echo base_url('assets/upload/image/'.$produk_related->gambar) ?>" alt="<?php echo $produk_related
                    ->nama_produk ?>">
