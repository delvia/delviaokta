...
<div class=" bgwhite">
    ...
    <p class="alert alert-success">Sudah memiliki akun? silahkan <a href= "<?php echo base_url('masuk')
    ?>" class="btn btn-info btn-sm">Login di sini</a></p>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    value= "<?php echo set_value('nama_pelanggan')?>" requiered></td>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    value= "<?php echo set_value('telepon')?>" requiered></td>
                </tr> 

                <tr>
                    <td>Alamat</td>
                    <td><textarea name="alamat" class="form-control" placeholder="Alamat"
                    value= "<?php echo set_value('alamat')?>"> </textarea></td>
